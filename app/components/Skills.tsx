      ...
      <div ref={containerRef} className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <motion.div
            ...
            transition={{ delay: 0.4 }}
          >
            <h3 className="text-2xl font-bold mb-8">Specialties</h3>
            <div className="grid grid-cols-2 gap-4">
              {specialties.map((specialty, index) => (
                <motion.div
                  ...
                  className="p-5 rounded-2xl glass group cursor-pointer"
                >
                  <motion.div
                    className="w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-500/20 to-purple-500/20 flex items-center justify-center mb-4 text-indigo-400 font-bold"
                  ...
                  <p className="text-zinc-500 text-sm">{specialty.description}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>
        ...
        <motion.div
          ...
          className="mt-20"
        >
          <h3 className="text-2xl font-bold text-center mb-12">Tools I Use</h3>
            ...
            >
              {[...tools, ...tools].map((tool, index) => (
                <motion.div
                  ...
                  className="flex-shrink-0 w-24 h-24 rounded-2xl glass flex flex-col items-center justify-center gap-2 cursor-pointer"
                >
                  <span className="text-2xl font-bold gradient-text">{tool.icon}</span>
        ...
        <motion.div
          ...
          className="mt-24"
        >
          <h3 className="text-2xl font-bold text-center mb-12">My Process</h3>
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              >
                ...
                >
                  <motion.div
                    className="w-16 h-16 rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center mx-auto mb-4"
