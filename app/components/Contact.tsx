...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-32 relative overflow-hidden">
      ...
      <motion.div
        className="absolute top-0 right-0 w-[600px] h-[600px] bg-indigo-500/10 rounded-full blur-3xl"
        ...
        <div className="grid lg:grid-cols-2 gap-16">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                ...
                >
                  <input
                    ...
                    className="w-full bg-zinc-900 border-none px-5 py-4 text-white placeholder-zinc-500 focus:outline-none"
              ...
              >
                ...
                >
                  <textarea
                    ...
                    onBlur={() => setFocusedField(null)}
                    rows={5}
                    className="w-full bg-zinc-900 border-none px-5 py-4 text-white placeholder-zinc-500 focus:outline-none resize-none"
              ...
              >
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full py-4 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-medium magnetic-btn"
                >
                  Send Message
                </motion.button>
              </motion.div>
          ...
          >
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-400">hello@mustafa.design</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-400">Available Worldwide (Remote)</p>
                </div>
              </div>
            </motion.div>
              ...
              <div className="flex gap-3">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="w-12 h-12 rounded-xl bg-zinc-900 flex items-center justify-center text-zinc-400 hover:text-indigo-400 hover:bg-zinc-800 transition-colors"
                    title={social.name}
                  >
            ...
            <motion.div
              ...
              animate={isInView ? { opacity: 1, y: 0 } : {}}
              transition={{ delay: 1 }}
              className="p-6 rounded-2xl animated-border"
            >
